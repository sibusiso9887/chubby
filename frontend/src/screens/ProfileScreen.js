        ...
        <Form className='create_profile_form' onSubmit={submitHandler}>
          ...
          <div className='create_profile_page_form_center' >
            ...
            <Form.Group className="create_profile_page_form_form_input_container" controlId="body">
              <Form.Label className='create_profile_page_form_form_input_container_label'>Body</Form.Label>
              <Form.Select
                value={body}
            ...
            <Form.Group className="create_profile_page_form_form_input_container" controlId="philosophy">
              <Form.Label className='create_profile_page_form_form_input_container_label' > philosophy</Form.Label>
              <Form.Control
                value={philosophy}
            ...
            <Form.Group className="create_profile_page_form_form_input_container" controlId="image">
              <Form.Label className='create_profile_page_form_form_input_container_label' > image</Form.Label>
              <Form.Control
                value={image}
